...
class controlador_nom_clasificacion extends \gamboamartin\nomina\controllers\controlador_nom_clasificacion {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->titulo_lista = 'Clasificación Nóminas';

        $this->sidebar['lista']['titulo'] = "Clasificacion Nominas";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Clasificacion Nominas";
        $this->sidebar['alta']['stepper_active'] = true;
        $this->sidebar['alta']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_lateral_active: true));

        $this->sidebar['modifica']['titulo'] = "Modifica Clasificacion Nominas";
