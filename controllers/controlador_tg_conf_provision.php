...
class controlador_tg_conf_provision extends _ctl_base
{
    ...
    {
        $modelo = new tg_conf_provision(link: $link);
        $html_ = new tg_conf_provision_html(html: $html);
    ...
    private function init_datatable(): stdClass
    {
        ...
        $filtro = array("tg_conf_provision.id", "tg_conf_provision.codigo", "tg_conf_provision.descripcion");
    ...
    {
        $keys_selects = $this->init_selects(keys_selects: array(), key: "nom_conf_empleado_id", label: "Conf. Empleado",
            cols: 6);
        return $this->init_selects(keys_selects: $keys_selects, key: "tg_tipo_provision_id", label: "Tipo de Provisión",
            cols: 6);
    }
