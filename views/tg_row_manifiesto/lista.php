...
<?php include 'templates/tg_tipo_servicio/lista/secciones.php'; ?>
                    ...
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table class="table ">
                            ...
                            <?php foreach ($controlador->registros as $registro){?>
                                <tr>
                                    <td><?php echo $registro->tg_tipo_servicio_id; ?></td>
                                    <td><?php echo $registro->tg_tipo_servicio_codigo; ?></td>
                                    <td><?php echo $registro->tg_tipo_servicio_codigo_bis?></td>
                                    <td><?php echo $registro->tg_tipo_servicio_descripcion; ?></td>
