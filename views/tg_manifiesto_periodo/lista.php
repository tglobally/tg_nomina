...
<?php include 'templates/tg_manifiesto_periodo/lista/secciones.php'; ?>
                    ...
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table class="table ">
                            ...
                            <?php foreach ($controlador->registros as $registro){?>
                                <tr>
                                    <td><?php echo $registro->tg_manifiesto_periodo_id; ?></td>
                                    <td><?php echo $registro->tg_manifiesto_periodo_codigo; ?></td>
                                    <td><?php echo $registro->tg_manifiesto_periodo_codigo_bis?></td>
                                    <td><?php echo $registro->tg_manifiesto_periodo_descripcion; ?></td>
