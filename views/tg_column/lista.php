...
<?php include 'templates/tg_column/lista/secciones.php'; ?>
                    ...
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table class="table ">
                            ...
                            <?php foreach ($controlador->registros as $registro){?>
                                <tr>
                                    <td><?php echo $registro->tg_column_id; ?></td>
                                    <td><?php echo $registro->tg_column_codigo; ?></td>
                                    <td><?php echo $registro->tg_column_codigo_bis?></td>
                                    <td><?php echo $registro->tg_column_descripcion; ?></td>
