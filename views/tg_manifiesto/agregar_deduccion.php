...
<div class="col-md-9 formulario">
    <div class="col-lg-12">
        ...
        <div class="  form-main" id="form">
            <form method="post" action="<?php echo $controlador->link_tg_manifiesto_agregar_deduccion_bd; ?>" class="form-additional">

                <input id="agregar_deduccion" name="agregar_deduccion" type="hidden" value="<?php echo  implode(",", $controlador->nominas_seleccionadas); ?>">
